...
public class UserController implements UserApi {
    ...
    @Override
    public ResponseEntity<UserResponse> getUserById(@PathVariable @Min(value = 1) Long id) {
    ...
    @Override
    public ResponseEntity<Void> deactivateUser(@PathVariable @Min(value = 1) Long id) {
